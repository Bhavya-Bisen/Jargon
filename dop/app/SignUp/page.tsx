...
import { useRouter } from "next/navigation"; // Use the correct router hook for the Next.js app directory
  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push("/"); // Navigate to the home page after successful registration
      } else {
